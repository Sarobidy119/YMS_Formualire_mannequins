...
<div className="sticky bottom-0 -mx-6 mt-6 flex gap-3 border-t border-gray-100 bg-white/95 px-6 py-4 backdrop-blur pb-safe">
          <button
            type="button"
            onClick={prevStep}
            disabled={step === 1}
            className="flex-1 rounded-xl border border-gray-200 px-4 py-3 text-sm font-semibold text-gray-600 transition hover:bg-gray-50 disabled:opacity-30 active:scale-[0.98]"
          >
            Précédent
          </button>
          {step < STEP_LABELS.length ? (
            <button
              type="button"
              onClick={nextStep}
              className="flex-1 rounded-xl bg-yms-600 px-4 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-yms-700 active:scale-[0.98]"
            >
              Suivant
            </button>
          ) : (
            <button
              ...
              disabled={submitting}
              className="flex-1 rounded-xl bg-yms-600 px-4 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-yms-700 disabled:opacity-50 active:scale-[0.98]"
            >
